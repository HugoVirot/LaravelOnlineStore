                ...
                <div class="card text-center col-md-6 p-3 m-3\" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        @if (isset($article->campagnes[0]) && $article->campagnes !== null)
                            <p class="card-text text-danger font-weight-bold">{{ $article->campagnes[0]->nom }} :
                        ...
                        <div class="container border border-info p-2 mt-3 mb-3">
                            ...
                            <form method="post" action="{{ route('avis.store') }}" class="w-50 m-auto">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control" name="note" id="note" min="1"
                                        max="5">
                                </div>
                                <div class="form-group">
                                    <label for="commentaire">Commentaire (facultatif)</label>
                                    <textarea type="textarea" class="form-control" name="commentaire" rows="4" cols="33"
                                        id="commentaire">Un super produit, etc</textarea>
                                </div>
