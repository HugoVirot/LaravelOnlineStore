...
<script>
    ...
    function showList($listId) {
        var articlesForm = document.getElementById($listId);
        if (articlesForm.style.display == "block") {
...
<div class="container text-center pt-3 mb-3">
    ...
    <div class="row mb-3 justify-content-around">
        ...
        <button class="btn btn-lg btn-primary" onclick="showCreationForm('campaignsForm')">Créer une campagne promo</button>
    </div>
    <div class="row justify-content-around">
        <button class="btn btn-lg btn-secondary" onclick="showList('articlesList')">Liste des articles</button>
        <button class="btn btn-lg btn-secondary" onclick="showList('rangesList')">Liste des gammes</button>
        <button class="btn btn-lg btn-secondary" onclick="showList('campaignsList')">Liste des campagnes</button>
        <button class="btn btn-lg btn-secondary" onclick="showList('usersList')">Liste des utilisateurs</button>
    </div>
    ...
    <div class="container w-50 p-5" style="display:none" id="articlesForm">
        ...
        <form method="post" action="{{route('articles.store')}}">
            ...
            <div class="form-group">
                ...
                <input required type="text" class="form-control" name="description_detaillee" value="" id="description_detaillee">
            </div>
            <div class="form-group">
    ...
    <div class="container p-5" style="display:none" id="articlesList">
        ...
        <table class="table table-info">
            ...
            <tr>
                ...
                <td>{{$article->stock}}</td>
                <td>{{$article->note}}</td>
                <td><a href="{{ route('articles.edit', $article) }}"><button class="btn btn-warning">Modifier</button></a></td>
                <td>
    ...
    <h3 class="mb-3">Liste des gammes</h3>
        ...
        <table class="table table-info">
            ...
            <tr>
                <td>{{$gamme->id}}</td>
                <td>{{$gamme->nom}}</td>
                <td><a href="{{ route('gammes.edit', $gamme) }}"><button class="btn btn-warning">Modifier</button></a></td>
                <td>
...
<div class="container p-5" style="display:none" id="campaignsList">
    ...
    <table class="table table-info">
        ...
        <tr>
            ...
            <td><a href="{{ route('campagnes.edit', $campagne) }}"><button class="btn btn-warning">Modifier</button></a></td>
            <td>
